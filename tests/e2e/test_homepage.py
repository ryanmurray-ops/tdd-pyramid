...
def test_duties_section_exists(open_homepage):
    expect(open_homepage.locator("#duties-section")).to_be_visible()
...
def test_duty_description_exists(open_homepage):
    expect(open_homepage.locator("#duty-description-input")).to_be_visible()

def test_duty_description_input_has_label(open_homepage):
    expect(open_homepage.get_by_label("Duty Description")).to_be_visible()
